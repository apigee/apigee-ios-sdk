...
NSString *const kApigeeSSKeychainErrorDomain = @"com.samsoffes.sskeychain";

NSString *const kApigeeSSKeychainAccountKey = @"acct";
NSString *const kApigeeSSKeychainCreatedAtKey = @"cdat";
NSString *const kApigeeSSKeychainClassKey = @"labl";
NSString *const kApigeeSSKeychainDescriptionKey = @"desc";
NSString *const kApigeeSSKeychainLabelKey = @"labl";
NSString *const kApigeeSSKeychainLastModifiedKey = @"mdat";
NSString *const kApigeeSSKeychainWhereKey = @"svce";

#if __IPHONE_4_0 && TARGET_OS_IPHONE
CFTypeRef SSKeychainAccessibilityType = NULL;
#endif

@interface ApigeeSSKeychain ()
+ (NSMutableDictionary *)_queryForService:(NSString *)service account:(NSString *)account;
@end

@implementation ApigeeSSKeychain
...
+ (NSArray *)accountsForService:(NSString *)service error:(NSError **)error {
    ...
    if (status != noErr && error != NULL) {
        *error = [NSError errorWithDomain:kApigeeSSKeychainErrorDomain code:status userInfo:nil];
        return nil;
    }
