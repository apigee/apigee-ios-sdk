...
@interface AddFormTableViewCell : UITableViewCell <UITextFieldDelegate>
...
@implementation AddFormTableViewCell
...
- (id)init {
    if (self = [super initWithStyle:UITableViewStyleGrouped]) {
        ...
        self.cells =
        @[[[AddFormTableViewCell alloc] initWithTitle:@"Title" key:@"title" binding:self.values],
          [[AddFormTableViewCell alloc] initWithTitle:@"Author" key:@"author" binding:self.values]];
    }
    return self;
}
...
{
    AddFormTableViewCell *formCell = (AddFormTableViewCell *) cell;
    formCell.textField.text = [formCell.binding objectForKey:formCell.key];
}

- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    AddFormTableViewCell *formCell = (AddFormTableViewCell *)[tableView cellForRowAtIndexPath:indexPath];
...
- (void) save:(id) sender
{
    for (AddFormTableViewCell *cell in self.cells) {
