...
@synthesize apigeeClient, monitoringClient, dataClient, apiClient;
...
//        (UsersAppDelegate *)[[UIApplication sharedApplication] delegate];
    ...
    apigeeClient = [[ApigeeClient alloc]
                                initWithOrganizationId:orgName
                                applicationId:appName];
    
    //Retrieve instances of ApigeeClient.monitoringClient and ApigeeClient.dataClient
    monitoringClient = [self.apigeeClient monitoringClient]; //used to call App Monitoring methods
    dataClient = [self.apigeeClient dataClient]; //used to call data methods
    
    apiClient = [[UsersApiClient alloc] initWithApigeeClient:apigeeClient];
