...
@property (strong, nonatomic) NSString *responseDataSize;
@property (strong, nonatomic) NSString *backendResponseTime;
@property (strong, nonatomic) NSString *backendReceiptTime;
