...
// but any number of ApigeeConnection objects may be created and separately configured.
...
// We recommend (but do not require) that they be made with instances of the ApigeeHTTPClient class.
//
