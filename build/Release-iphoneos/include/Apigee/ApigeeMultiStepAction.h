...
// ApigeeMultiStepAction is used internally for client actions that
// require multiple transactions with the service. It is simple data
// storage, used by ApigeeClient in abstracting out multi-step transactions
@interface ApigeeMultiStepAction : NSObject

// the transaction ID that this multistep is associated
// with. When a transaction of this ID is complete, this is the
// ApigeeMultiStepAction instance ot ask what to do next
...
@property (unsafe_unretained) NSString *userID;
@property (unsafe_unretained) NSString *groupID;
@property (unsafe_unretained) NSDictionary *activity;
