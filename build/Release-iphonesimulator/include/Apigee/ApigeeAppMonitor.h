...
#import "ApigeeMetricsUploadListener.h"

@class ApigeeAppIdentification;
@class ApigeeDataClient;


@interface ApigeeAppMonitor : NSObject
...
// options
+ (BOOL)setUploadListener:(id<ApigeeMetricsUploadListener>)listener options:(NSMutableDictionary*)dictOptions;
+ (id<ApigeeMetricsUploadListener>)metricsUploadListenerFromOptions:(NSDictionary*)dictOptions;

+ (BOOL)setCrashReportingEnabled:(BOOL)crashReportingEnabled options:(NSMutableDictionary*)dictOptions;
+ (NSNumber*)crashReportingEnabledFromOptions:(NSDictionary*)dictOptions;

+ (BOOL)setInterceptNetworkCallsEnabled:(BOOL)autoInterceptCalls options:(NSMutableDictionary*)dictOptions;
+ (NSNumber*)interceptNetworkCallsEnabledFromOptions:(NSDictionary*)dictOptions;


/**
 Returns the shared instance of ApigeeAppMonitor. This method is
 provided as a convenience method. Ideally, your app delegate should
 maintain a reference to the single instance of ApigeeAppMonitor.
 
 @return instance of ApigeeAppMonitor
 */
+ (id)sharedInstance;

/**
 Initializes ApigeeAppMonitor which controls the Apigee mobile agent.
 ...
 @return initialized instance of ApigeeAppMonitor
 */
...
- (id) initWithAppIdentification: (ApigeeAppIdentification*) appIdentification
                  ...
                  crashReporting: (BOOL) crashReportingEnabled
           interceptNetworkCalls: (BOOL) autoInterceptCalls
                  uploadListener: (id<ApigeeMetricsUploadListener>)uploadListener;
...
- (BOOL)addMetricsUploadListener:(id<ApigeeMetricsUploadListener>)metricsUploadListener;
- (BOOL)removeMetricsUploadListener:(id<ApigeeMetricsUploadListener>)metricsUploadListener;
